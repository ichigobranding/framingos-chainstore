                  ...
                  <div class="ibskinArticleBody2">
                      <!--記事info-->
                        <div class="ibarticleDetailArea">
                            <p><time datetime="2016-08-12" pubdate="pubdate"><?php echo get_the_date(); ?></time><?php get_template_part( 'new' ); ?></p>
                              <div class="temablog">
                                <p>テーマ：<?php echo get_the_term_list( $id,tema, $before, $sep, $after ); ?><p>
                              </div>
                        </div>
                      <!--記事info-->
                      <!--記事　中身-->

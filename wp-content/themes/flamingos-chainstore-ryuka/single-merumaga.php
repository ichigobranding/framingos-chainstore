                                                ...
                                                <div class="ibskinArticle3">
                                                      <div class="ibskinArticleHeader">
                                                          <div class="ibskinArticleTitle">
                                                                <h1>
                                                                  <b>「女性がいつまでも健康とキレイを手に入れる方法」配信しました。(<?php echo get_the_date('n月j日'); ?>号)</b>
                                                                </h1>
                                                          </div>
                                                      </div>
                                                          ...
                                                          <!--記事info-->
																			...
																			<b>これから先、３０年、４０年、５０年と、いつまでの若々しく、健康でいられるコツをお伝えします。</b><br><br>

																			メルマガにご登録されている方はぜひ読んで、漢方的の知恵を、毎日の生活に取り入れてみてくださいね。<br><br>

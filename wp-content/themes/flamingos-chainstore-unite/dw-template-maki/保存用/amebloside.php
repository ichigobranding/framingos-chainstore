 <!-- ameblo -->
  <div class="ibMenu">
      <div class="ibMenuHeader">
          <p><span class="ibMenuTitle">アメブロ 最新の記事</span><p>
      </div>
...
<?php
    //以下3行の項目を任意に変更
      ...
      ///下部の一覧も編集する//////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////
      $feed = fetch_feed('http://rssblog.ameba.jp/woman-pc/rss20.xml'); 
      ////////////////////////////////////////////////////////////////////
      ///下部の一覧も編集する//////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////
...
?>
    <ul class="ibskinSubList">
          ...
          <li>
            <p>
            <a href="<?php echo $item->get_permalink(); ?>" target="blank"><?php echo $item->get_title(); ?></a><?php get_template_part( 'new' ); ?></p>
          </li>
          <?php $counter++;
                endif;
                endforeach; ?>
        ...
        <!-- アメブロの一覧を変更する ///////////////////-->
        <!-- ///////////////////////////////////////-->
         <a href="http://ameblo.jp/ichigo-meishi/entrylist.html" target="blank">
         <!-- ///////////////////////////////////////-->
         <!-- アメブロの一覧を変更する ///////////////////-->
         <!-- ///////////////////////////////////////-->
         一覧を見る</a>
